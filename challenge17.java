...
class challenge17
{
    ...
    for(int i=0;i<n;i++)
    {
      ...
      totalmarks(n,name,roll,math,english,science,lan,social,total);
      topscorer(n,name,roll,total);
      average(n,roll,name,total,avg);
      passstudentlist(n,name,roll,math,english,science,lan,social);
      failstudentlist(n,name,roll,math,english,science,lan,social);
      scorecard(n,name,roll,grade,total,avg,math,english,science,lan,social);
      his(n,avg);
